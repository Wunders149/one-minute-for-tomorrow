...
export default function RitualButton({ 
  ...
  const baseStyles = "relative inline-flex items-center justify-center px-8 py-4 overflow-hidden font-serif tracking-widest uppercase text-sm transition-all duration-500 ease-out rounded-full group disabled:opacity-50 disabled:cursor-not-allowed";
